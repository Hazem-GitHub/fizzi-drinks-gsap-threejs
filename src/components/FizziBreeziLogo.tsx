...
export function FizziBreeziLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      aria-labelledby="fizzi-breezi-logo-title"
    >
      <title id="fizzi-breezi-logo-title">Fizzi Breezi</title>
